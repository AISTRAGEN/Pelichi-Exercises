...
{
  std::string result = "Model:" + m_Model +
                  ", YearOfProduction:" + std::to_string(m_YearOfProduction) +
                  ", Price:" + std::to_string(m_Price) +
                  ", TankVolume:" + std::to_string(m_TankVolume) +
                  ", CurrentFuelVolume:" + std::to_string(m_CurrentFuelVolume) +
                  ", Color:" + std::to_string(static_cast<int>(m_color));
  return result;
}
